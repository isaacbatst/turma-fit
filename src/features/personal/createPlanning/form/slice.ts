...
import { addExercisesSeries, addTraining, removeTraining, setPlanningType, removeAllTrainings, setExercises, saveTraining } from "./reducers";
...
export const { 
  ...
  setExercises: setExercisesAction,
